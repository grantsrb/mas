...
under a new directory with the name of the model.
{
    ...
    "layers": { # a dict of the the model's latent states for each argued layer
        "<layer_name>": tensor (B,...)
...
with torch.no_grad():
    ...
    for i in tqdm(range(0, len(input_ids), bsize)):
        ...
        generated_ids.append(generated.sequences[0])
        logits.append(generated.scores[0])  # (B, S_gen, V)
